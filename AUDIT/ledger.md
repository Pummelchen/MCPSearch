...
| B104 | S2 | `MCPSMonitor` | (bisect required) | `mcps-mon` crashes on startup in a **debug** build, while release and the pre-audit baseline both run | bug | START | this Mac | Phase D (found while testing B10) |
